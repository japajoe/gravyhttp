...
{
    static std::unordered_map<HttpContentType, std::string> contentTypeToStringTable;
    static std::unordered_map<std::string, HttpContentType> stringToContentTypeTable;
    ...
    static void InitializeHttpContentMaps()
    {
        if(contentTypeToStringTable.size() > 0)
            return;

        contentTypeToStringTable[HttpContentType::ApplicationEDIX12] = "application/EDI-X12";
        contentTypeToStringTable[HttpContentType::ApplicationEDIFACT] = "application/EDIFACT";
        contentTypeToStringTable[HttpContentType::ApplicationJavaScript] = "application/javascript";
        contentTypeToStringTable[HttpContentType::ApplicationOctetStream] = "application/octet-stream";
        contentTypeToStringTable[HttpContentType::ApplicationOgg] = "application/ogg";
        contentTypeToStringTable[HttpContentType::ApplicationPdf] = "application/pdf";
        contentTypeToStringTable[HttpContentType::ApplicationXhtmlXml] = "application/xhtml+xml";
        contentTypeToStringTable[HttpContentType::ApplicationXShockWaveFlash] = "application/x-shockwave-flash";
        contentTypeToStringTable[HttpContentType::ApplicationJson] = "application/json";
        contentTypeToStringTable[HttpContentType::ApplicationLdJson] = "application/ld+json";
        contentTypeToStringTable[HttpContentType::ApplicationXml] = "application/xml";
        contentTypeToStringTable[HttpContentType::ApplicationZip] = "application/zip";
        contentTypeToStringTable[HttpContentType::ApplicationXWWWFormUrlEncoded] = "application/x-www-form-urlencoded";
        contentTypeToStringTable[HttpContentType::AudioMpeg] = "audio/mpeg";
        contentTypeToStringTable[HttpContentType::AudioXMSWma] = "audio/x-ms-wma";
        contentTypeToStringTable[HttpContentType::AudioVndRnRealAudio] = "audio/vnd.rn-realaudio";
        contentTypeToStringTable[HttpContentType::AudioXWav] = "audio/x-wav";
        contentTypeToStringTable[HttpContentType::ImageGif] = "image/gif";
        contentTypeToStringTable[HttpContentType::ImageJpeg] = "image/jpeg";
        contentTypeToStringTable[HttpContentType::ImagePng] = "image/png";
        contentTypeToStringTable[HttpContentType::ImageTiff] = "image/tiff";
        contentTypeToStringTable[HttpContentType::ImageVndMicrosoftIcon] = "image/vnd.microsoft.icon";
        contentTypeToStringTable[HttpContentType::ImageXIcon] = "image/x-icon";
        contentTypeToStringTable[HttpContentType::ImageVndDjvu] = "image/vnd.djvu";
        contentTypeToStringTable[HttpContentType::ImageSvgXml] = "image/svg+xml";
        contentTypeToStringTable[HttpContentType::MultiPartMixed] = "multipart/mixed";
        contentTypeToStringTable[HttpContentType::MultiPartAlternative] = "multipart/alternative";
        contentTypeToStringTable[HttpContentType::MultiPartRelated] = "multipart/related";
        contentTypeToStringTable[HttpContentType::MultiPartFormData] = "multipart/form-data";
        contentTypeToStringTable[HttpContentType::TextCss] = "text/css";
        contentTypeToStringTable[HttpContentType::TextCsv] = "text/csv";
        contentTypeToStringTable[HttpContentType::TextHtml] = "text/html";
        contentTypeToStringTable[HttpContentType::TextJavaScript] = "text/javascript";
        contentTypeToStringTable[HttpContentType::TextPlain] = "text/plain";
        contentTypeToStringTable[HttpContentType::TextXml] = "text/xml";
        contentTypeToStringTable[HttpContentType::VideoMpeg] = "video/mpeg";
        contentTypeToStringTable[HttpContentType::VideoMp4] = "video/mp4";
        contentTypeToStringTable[HttpContentType::VideoQuickTime] = "video/quicktime";
        contentTypeToStringTable[HttpContentType::VideoXMSWmv] = "video/x-ms-wmv";
        contentTypeToStringTable[HttpContentType::VideoXMSVideo] = "video/x-msvideo";
        contentTypeToStringTable[HttpContentType::VideoXFlv] = "video/x-flv";
        contentTypeToStringTable[HttpContentType::VideoWebM] = "video/webm";
        contentTypeToStringTable[HttpContentType::ApplicationVndOasisOpenDocumentText] = "application/vnd.oasis.opendocument.text";
        contentTypeToStringTable[HttpContentType::ApplicationVndOasisOpenDocumentSpreadSheet] = "application/vnd.oasis.opendocument.spreadsheet";
        contentTypeToStringTable[HttpContentType::ApplicationVndOasisOpenDocumentPresentation] = "application/vnd.oasis.opendocument.presentation";
        contentTypeToStringTable[HttpContentType::ApplicationVndOasisOpenDocumentGraphics] = "application/vnd.oasis.opendocument.graphics";
        contentTypeToStringTable[HttpContentType::ApplicationVndMSExcel] = "application/vnd.ms-excel";
        contentTypeToStringTable[HttpContentType::ApplicationVndOpenXmlFormatsOfficeDocumentSpreadSheetMLSheet] = "application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
        contentTypeToStringTable[HttpContentType::ApplicationVndMSPowerpoint] = "application/vnd.ms-powerpoint";
        contentTypeToStringTable[HttpContentType::ApplicationVndOpenXmlFormatsOfficeDocumentPresentationMLPresentation] = "application/vnd.openxmlformats-officedocument.presentationml.presentation";
        contentTypeToStringTable[HttpContentType::ApplicationMSWord] = "application/msword";
        contentTypeToStringTable[HttpContentType::ApplicationVndOpenXmlFormatsOfficeDocumentWordProcessingMLDocument] = "application/vnd.openxmlformats-officedocument.wordprocessingml.document";
        contentTypeToStringTable[HttpContentType::ApplicationVndMozillaXulXml] = "application/vnd.mozilla.xul+xml";
        contentTypeToStringTable[HttpContentType::Unknown] = "unknown";

        for(auto &item : contentTypeToStringTable)
        {
            stringToContentTypeTable[item.second] = item.first;
        }
    ...
    HttpContentType HttpContent::GetTypeFromFileExtension(const std::string &filePath)
    {
        InitializeHttpContentMaps();

        HttpContentType contentType = HttpContentType::ApplicationOctetStream;

        std::string mimeType;
        
        if(TryGetMimeType(filePath, mimeType))
        {
            if(stringToContentTypeTable.count(mimeType))
            {
                return stringToContentTypeTable[mimeType];
            }
        }
    ...
    void HttpContent::GetTypeFromHeader(const std::string &header, HttpContentType &contentType, HttpCharSet &charSet)
    {
        InitializeHttpContentMaps();

        contentType = HttpContentType::Any;
        charSet = HttpCharSet::UTF8;

        if(String::Contains(header, ";"))
        {
            auto components = String::Split(header, ';');

            if(stringToContentTypeTable.count(components[0]))
                contentType = stringToContentTypeTable[components[0]];

            if(stringToCharSetTable.count(components[1]))
                charSet = stringToCharSetTable[components[1]];
        }
        else
        {
            std::string h = header;

            if(stringToContentTypeTable.count(h))
                contentType = stringToContentTypeTable[h];
        }
    }

    std::string HttpContent::GetStringFromContentType(HttpContentType contentType)
    {
        InitializeHttpContentMaps();

        if(contentTypeToStringTable.count(contentType) > 0)
        {
            return contentTypeToStringTable[contentType];
        }

        return "application/octet-stream";
    }

    bool HttpContent::TryGetMimeType(const std::string &fileNameOrExtension, std::string &mimeType)
    {
        InitializeHttpContentMaps();
